<template>
  <div class="space-y-6">
    <section class="dashboard-metrics" :aria-label="t('dashboard.title')">
      <div class="dashboard-metrics-primary">
        <article v-if="!isSimple" class="dashboard-metric dashboard-metric-primary">
          <div class="dashboard-metric-label">
            <Icon name="creditCard" size="sm" />
            <span>{{ t('dashboard.balance') }}</span>
          </div>
          <p class="dashboard-metric-value dashboard-metric-value-accent">${{ formatBalance(balance) }}</p>
        ...
        <article class="dashboard-metric dashboard-metric-primary">
          ...
          <p class="dashboard-metric-meta dashboard-metric-meta-success">
        ...
        <article class="dashboard-metric dashboard-metric-primary">
          ...
          <p class="dashboard-metric-value dashboard-metric-value-accent" :title="t('dashboard.actual')">
            ${{ formatCost(stats?.today_actual_cost || 0) }}
          </p>
          <p class="dashboard-metric-meta">
            {{ t('dashboard.standard') }} ${{ formatCost(stats?.today_cost || 0) }} · {{ t('common.total') }} ${{ formatCost(stats?.total_actual_cost || 0) }}
          </p>
        </article>
      </div>

      <div class="dashboard-metrics-secondary">
        ...
        <article class="dashboard-metric">
          ...
          <p class="dashboard-metric-value dashboard-metric-value-secondary">
            {{ formatTokens(stats?.rpm || 0) }} <span class="dashboard-metric-unit">RPM</span>
          </p>
        ...
        <article class="dashboard-metric">
          ...
          <p class="dashboard-metric-value dashboard-metric-value-secondary">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
